...
# Important Resources:
* Drive link.
* [[#Personal Account (Student Information System - SIS): Important|Your personal account]].
...
* [Permitted Absence Times Calculator](https://chs-absence.vercel.app/) Check [[#Attendance Important|Attendance]] section for more info.
* [Auto Evaluator](https://github.com/mostafa-abdelbrr/auto-skip-cufe-chs-staff-evaluation) Check [[#Evaluation Important|Evaluation]] section for more info.

# Myths (all untrue) #Myths
...
# Registration #Important #Registration
...
# Payment #Important #Registration 
...
You can ask the Credit Student Affairs for your total as well, normally they have this info available after the Drop only phase, which means the info is available from week 3 to week 5. Your payment code for Fawry is noted on your ID card and on your [[#Profile]], it is 14 numbers long.

# Withdrawal #Important #Registration

You are allowed to withdraw from **only 2 courses per semster**.

# Retaking a course #Important #Registration
...
# Industrial Training (IT) #IT #Important
...
# Personal Account (Student Information System - SIS): #Important
...
* Allows you to withdraw from any course, revise [[#Withdrawal Important Registration|withdrawal guidelines]].
#### Edit profile
